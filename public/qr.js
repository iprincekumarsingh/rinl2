        ...
        e.removeEventListener("click", t),
            ...
            Logger.logAntiEmbedActionNavigateToScanApp(function () {
                window.parent.location.href =
                    "https://scanapp.org#referral=anti-embed";
            });
    });
    var n = 6;
    (t.disabled = !0),
        (function e() {
            n--,
                ...
                n > 0
                    ? setTimeout(e, 1e3)
                    : ((t.innerText = "Continue using here"),
                      (t.disabled = !1));
        })(),
        t.addEventListener("click", function e() {
            (t.disabled = !0),
                ...
                Logger.logAntiEmbedActionContinueHere(function () {
                    document.getElementById("iframe-alert").style.display =
                        "none";
                });
        });
}
...
(QrResult.prototype.onScanSuccess = function (e, t, n) {
    ...
    docReady(function () {
        ...
        t.render(function (e, o) {
            console.log(e, o),
                t.getState() !== Html5QrcodeScannerState.NOT_STARTED &&
                    t.pause(!0);
            let i = "camera";
            t.getState() === Html5QrcodeScannerState.NOT_STARTED &&
                (i = "file"),
